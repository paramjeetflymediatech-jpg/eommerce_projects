...
export default function NewProductPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Swal.fire({ title: "Success", text: "Product created!", icon: "success", confirmButtonColor: "#000" }).then(() => {
  ...
  return (
    <div style={s.container}>
      <header style={s.header}>
        <div>
          <h1 style={s.title}>New Product</h1>
          <p style={s.subtitle}>Add a new product to your inventory.</p>
        </div>
